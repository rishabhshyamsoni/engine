	...
	<div class="row">
		<div class="col-md-12">
			...
			<p class="text-success lead">
				Welcome to C.M.S. View...
			</p>
			<blockquote class="blockquote">
				<p class="mb-0">
					You can choose either you want to open application for Add Customer or Show Customer....
				</p>
		...
		<center> <a href="signin3.jsp" class="btn btn-link" type="button">Home</a></center>
